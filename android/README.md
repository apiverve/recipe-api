...
```gradle
dependencies {
    implementation 'com.github.apiverve:recipe-api:1.1.14'
}
```
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/recipe](https://docs.apiverve.com/ref/recipe)
...
- **Documentation:** [https://docs.apiverve.com/ref/recipe](https://docs.apiverve.com/ref/recipe)
- **Issues:** [GitHub Issues](https://github.com/apiverve/recipe-api/issues)
