...
[![RubyGems](https://img.shields.io/badge/RubyGems-E9573F?style=flat&logo=rubygems&logoColor=white)](https://rubygems.org/gems/apiverve_recipe)
[![Packagist](https://img.shields.io/badge/Packagist-F28D1A?style=flat&logo=packagist&logoColor=white)](https://packagist.org/packages/apiverve/recipe)
[![Go](https://img.shields.io/badge/Go-00ADD8?style=flat&logo=go&logoColor=white)](#-go)
[![Dart](https://img.shields.io/badge/Dart-0175C2?style=flat&logo=dart&logoColor=white)](https://pub.dev/packages/apiverve_recipe)
...
```bash
curl -X GET "https://api.apiverve.com/v1/recipe?name=chicken%20fajitas" \
...
[**View NPM Package →**](https://www.npmjs.com/package/@apiverve/recipe) | [**Package Code →**](./npm/)
...
```bash
pip install apiverve-recipe
```

[**View PyPI Package →**](https://pypi.org/project/apiverve-recipe/) | [**Package Code →**](./python/)
...
[**View RubyGems Package →**](https://rubygems.org/gems/apiverve_recipe) | [**Package Code →**](./ruby/)
...
```bash
composer require apiverve/recipe
```

[**View Packagist Package →**](https://packagist.org/packages/apiverve/recipe) | [**Package Code →**](./php/)
...
```bash
dart pub add apiverve_recipe
```

[**View pub.dev Package →**](https://pub.dev/packages/apiverve_recipe) | [**Package Code →**](./dart/)
...
```gradle
implementation 'com.github.apiverve:recipe-api:1.0.0'
```
