// Package recipe provides a Go client for the Recipe Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/recipe?utm_source=go&utm_medium=readme
package recipe
...
const (
	baseURL        = "https://api.apiverve.com/v1/recipe"
	defaultTimeout = 30 * time.Second
)

// Client is the Recipe Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Recipe Generator API client.
...
// Execute makes a request to the Recipe Generator API with typed parameters.
//
...
//   - name (required): string - The name or description of the recipe you want to generate
